...
var createWebSocket = function (stream) {
    ...
    try {
        var url =  window.location.protocol.replace('http', 'ws') + '//' + // http: -> ws:, https: -> wss:
        ...
        connection.onclose = function (e) {
            ...
            log('Web socket connection closed. ' + error.reason);
        };
    }
    catch(err) {
  ...
  recorder.ondataavailable = function(event) {
    ...
    log("Pushed more data...")
  } 

  recorder.start(100);
  log(recorder.state + "started...");
...
// var streamUrl = "rtmp://192.168.29.137:1935/live/coachroebuck?sign=" + ts + "-" + hash;
var streamUrl = "rtmp://192.168.200.18:1935/live/coachroebuck?sign=" + ts + "-" + hash;
